...
namespace LR5
{
    ...
    {
        public delegate void HowManyMoreYears(YearofStudy сours);
        public static event HowManyMoreYears HMMY;

        public int GroupNumber;
        public YearofStudy сourse;
    ...
    class Program
    {
        ...
        {
            Student.HMMY += delegate (Student.YearofStudy сours)
            {
                int Sum = 5 - (int)сours;
                Console.WriteLine($"---> {Sum} years left to study");
            };

            try
            {
                Console.WriteLine(Human.HowMuch);
                Human human1 = new Human("Daniil", "Drozd", 19);
                StudentBSUIR human3 = new StudentBSUIR("Ellen", "Ripley", 17, Student.YearofStudy.first, 233131, StudentBSUIR.Faculty.FCSN);
                StudentBSU human2 = new StudentBSU("Tarantul", "Taran", 22, Student.YearofStudy.third, 2358581, StudentBSU.Faculty.GDH);
                ...
                Human human4 = new Human("Vasya", "Vasil", "Vasilii", 190);
